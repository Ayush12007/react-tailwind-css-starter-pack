  ...
  return (
    <div className="scroll-smooth">
      ...
      <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 text-white">
        ...
        {/* Sub Heading */}
        <div className="-mt-3 w-[90%] text-center text-sm sm:text-lg font-bold text-richblack-300">
        ...
        {/* Video */}
        <div className="w-full max-w-4xl mx-3 my-7 shadow-[10px_-5px_50px_-5px] rounded-lg shadow-blue-200">
          <video
      ...
      <div className="bg-pure-greys-5 text-richblack-700">
        <div className="homepage_bg h-[320px]">
          ...
          <div className="mx-auto flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8">
            ...
            <div className="flex flex-col sm:flex-row gap-7 text-white lg:mt-8">
              <CTAButton active={true} linkto={"/signup"} className="w-full sm:w-auto">
      ...
      <div className="relative mx-auto my-20 flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 bg-richblack-900 text-white">
        ...
        <h1 className="text-center text-3xl sm:text-4xl font-semibold mt-8">
